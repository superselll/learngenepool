...
def get_callbacks(arch, rank, train_data_size, val_data_size, ckpt_dir,
                  best_ckpt_dir, summary_dir, ckpt_save_every_step=12500,
    ...
    ckpoint_cb = ModelCheckpoint(
        ...
        directory=best_ckpt_dir,#ckpt_dir,
        config=config_ck
    )
    '''
    ...
    #best_ckpt_save_cb = BestCheckpointSavingCallback(best_ckpt_dir, prefix=arch)
