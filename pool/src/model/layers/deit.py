...
from src.model.layers.vision_transformer_outmidmap import ViT_OutMidMap
...
def deit_base6_patch16_224(**kwargs):
    model = VisionTransformer(
...
def deit_small6_patch16_224(**kwargs):
    model = VisionTransformer(
        img_size=224, patch_size=16, embed_dim=384, depth=6, num_heads=12,
        mlp_ratio=4, qkv_bias=True,
        norm_layer=partial(nn.LayerNorm, epsilon=1e-6), **kwargs)
    model.default_cfg = _cfg(img_size=224, **kwargs)
    return model

def deit_tiny6_patch16_224(**kwargs):
    model = VisionTransformer(
        img_size=224, patch_size=16, embed_dim=192, depth=6, num_heads=12,
        mlp_ratio=4, qkv_bias=True,
        norm_layer=partial(nn.LayerNorm, epsilon=1e-6), **kwargs)
    model.default_cfg = _cfg(img_size=224, **kwargs)
    return model

def deit_base9_patch16_224(**kwargs):
    model = VisionTransformer(
        img_size=224, patch_size=16, embed_dim=768, depth=9, num_heads=12,
        mlp_ratio=4, qkv_bias=True,
        norm_layer=partial(nn.LayerNorm, epsilon=1e-6), **kwargs)
    model.default_cfg = _cfg(img_size=224, **kwargs)
    return model

def deit_small9_patch16_224(**kwargs):
    model = VisionTransformer(
        img_size=224, patch_size=16, embed_dim=384, depth=9, num_heads=12,
        mlp_ratio=4, qkv_bias=True,
        norm_layer=partial(nn.LayerNorm, epsilon=1e-6), **kwargs)
    model.default_cfg = _cfg(img_size=224, **kwargs)
    return model

def deit_tiny9_patch16_224(**kwargs):
    model = VisionTransformer(
        img_size=224, patch_size=16, embed_dim=192, depth=9, num_heads=12,
        mlp_ratio=4, qkv_bias=True,
        norm_layer=partial(nn.LayerNorm, epsilon=1e-6), **kwargs)
    model.default_cfg = _cfg(img_size=224, **kwargs)
    return model

def midmap_deit_tiny_patch16_224(**kwargs):
    model = ViT_OutMidMap(
...
def midmap_deit_tiny3_patch16_224(**kwargs):
    model = ViT_OutMidMap(
        img_size=224, patch_size=16, embed_dim=192, depth=3, num_heads=3, mlp_ratio=4, qkv_bias=True,
        norm_layer=nn.LayerNorm, **kwargs)
    model.default_cfg = _cfg(img_size=224, **kwargs)
    return model


def midmap_deit_tiny6_patch16_224(**kwargs):
    model = ViT_OutMidMap(
        img_size=224, patch_size=16, embed_dim=192, depth=6, num_heads=3, mlp_ratio=4, qkv_bias=True,
        norm_layer=nn.LayerNorm, **kwargs)
    model.default_cfg = _cfg(img_size=224, **kwargs)
    return model


def midmap_deit_tiny9_patch16_224(**kwargs):
    model = ViT_OutMidMap(
        img_size=224, patch_size=16, embed_dim=192, depth=9, num_heads=3, mlp_ratio=4, qkv_bias=True,
        norm_layer=nn.LayerNorm, **kwargs)
    model.default_cfg = _cfg(img_size=224, **kwargs)
    return model


def midmap_deit_small_patch16_224(**kwargs):
    model = ViT_OutMidMap(
...
def midmap_deit_small3_patch16_224(pretrained=False, pretrained_cfg=None, **kwargs):
    model = ViT_OutMidMap(
        img_size=224, patch_size=16, embed_dim=384, depth=3, num_heads=6, mlp_ratio=4, qkv_bias=True,
        norm_layer=nn.LayerNorm, **kwargs)
    model.default_cfg = _cfg(img_size=224, **kwargs)
    return model


def midmap_deit_small6_patch16_224(pretrained=False, pretrained_cfg=None, **kwargs):
    model = ViT_OutMidMap(
        img_size=224, patch_size=16, embed_dim=384, depth=6, num_heads=6, mlp_ratio=4, qkv_bias=True,
        norm_layer=nn.LayerNorm, **kwargs)
    model.default_cfg = _cfg(img_size=224, **kwargs)
    return model


def midmap_deit_small9_patch16_224(pretrained=False, pretrained_cfg=None, **kwargs):
    model = ViT_OutMidMap(
        img_size=224, patch_size=16, embed_dim=384, depth=9, num_heads=6, mlp_ratio=4, qkv_bias=True,
        norm_layer=nn.LayerNorm, **kwargs)
    model.default_cfg = _cfg(img_size=224, **kwargs)
    return model


def midmap_deit_base_patch16_224(**kwargs):
    model = ViT_OutMidMap(
...
def midmap_deit_base3_patch16_224(pretrained=False, pretrained_cfg=None, **kwargs):
    model = ViT_OutMidMap(
        img_size=224, patch_size=16, embed_dim=768, depth=3, num_heads=12, mlp_ratio=4, qkv_bias=True,
        norm_layer=nn.LayerNorm, **kwargs)
    model.default_cfg = _cfg(img_size=224, **kwargs)
    return model


def midmap_deit_base6_patch16_224(pretrained=False, pretrained_cfg=None, **kwargs):
    model = ViT_OutMidMap(
        img_size=224, patch_size=16, embed_dim=768, depth=6, num_heads=12, mlp_ratio=4, qkv_bias=True,
        norm_layer=nn.LayerNorm, **kwargs)
    model.default_cfg = _cfg(img_size=224, **kwargs)
    return model


def midmap_deit_base9_patch16_224(pretrained=False, pretrained_cfg=None, **kwargs):
    model = ViT_OutMidMap(
        img_size=224, patch_size=16, embed_dim=768, depth=9, num_heads=12, mlp_ratio=4, qkv_bias=True,
        norm_layer=nn.LayerNorm, **kwargs)
    model.default_cfg = _cfg(img_size=224, **kwargs)
    return model
